...
namespace Common
{
    public class ObjectBounds : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            _objectWidth = _transform.GetComponentInChildren<SpriteRenderer>().bounds.size.x / 2;
            _objectHeight = _transform.GetComponentInChildren<SpriteRenderer>().bounds.size.y / 2;
        }
